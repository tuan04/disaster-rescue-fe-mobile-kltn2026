...
export function getWebSocketUrl(): string {
  console.log(process.env.EXPO_PUBLIC_WS_URL);
  return process.env.EXPO_PUBLIC_WS_URL as string;
}
...
class WebSocketService {
  ...
  public connect(token?: string): void {
    ...
    this.client = new Client({
      ...
      reconnectDelay: 5000,
      // Đảm bảo tương thích với Spring Boot STOMP broker
      ...
      const subscription = this.client.subscribe(
        ...
        (message: IMessage) => {
          ...
          try {
            ...
            console.error(
              "[STOMP WS] Parse message JSON error:",
              e,
              message.body,
            );
          }
